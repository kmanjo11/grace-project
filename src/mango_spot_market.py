...
class EntityMapper:
    ...
    def to_mango_order(self, entities: Dict[str, Any]) -> Dict[str, Any]:
        ...
        order = {
            ...
            "type": self.order_type_mappings.get(entities.get("type", "").lower(), "market"),
    ...
    async def handle_trade_preparation(self, order: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "market": order["market"],
                "sufficient_balance": balances.get(market_info["quote_currency"], 0) >= required_balance,
...
class MangoSpotMarket:
    ...
    async def get_market_data(self, market_name: Optional[str] = None) -> Dict[str, Any]:
        """
