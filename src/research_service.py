...
class ResearchService:
    ...
    async def structured_research(self, source: str, topic: Optional[str] = None) -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            await self.memory_system.store(
                results,
                tags=["research", source, "structured"]
            )
            return results
        except Exception as e:
    ...
    async def _fetch_quantconnect(self, topic: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    def _validate_finding(self, finding: Dict[str, Any]) -> bool:
        ...
        if not valid:
            logger.warning(f"Invalid research finding: missing required fields {[f for f in required_fields if f not in finding]}")
        return valid
    ...
    def process_task(self, task_content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if task_type == "natural_research":
            ...
            try:
                ...
                return {"status": "error", "message": f"Error starting research: {str(e)}"}
            ...
            if not context:
                return {"status": "error", "message": "Context is required for research suggestions"}
            ...
            try:
                ...
                return {"status": "error", "message": f"Error suggesting research: {str(e)}"}
            ...
            if not token:
                return {"status": "error", "message": "Token symbol is required for community pulse"}
            ...
            try:
                ...
                return {
                    ...
                    "sentiment": "neutral",
                    "activity": "moderate",
                    "trending_topics": ["price action", "new developments", "market conditions"],
                ...
                return {"status": "error", "message": f"Error getting community pulse: {str(e)}"}
